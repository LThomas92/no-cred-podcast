...
$(document).ready(function () {
  ...
  const playButtonAudio = document.querySelector(".player-play-btn");
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    playButtonAudio.addEventListener("click", () => {
      ...
      if (playButtonAudio.dataset.playing === "false") {

        audioElement.play();

        playButtonAudio.dataset.playing = "true";
        ...
        playButtonAudio.dataset.playing = "false";
    ...
    function setTimes() {
      ...
      playerDuration.textContent = new Date(audioElement.duration * 1000).toISOString().substr(11, 8);
    }
